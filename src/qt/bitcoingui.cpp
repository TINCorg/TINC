    ...
    miningOnAction(0)
{
    ...
    QString windowTitle = tr("TINC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TINC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TINC: URIs)"));
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About TINC Core"), this);
    aboutAction->setStatusTip(tr("Show information about TINC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TINC Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TINC addresses to prove you own them"));
    verifyMessageAction = new QAction(TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TINC addresses"));
    ...
    openAction->setStatusTip(tr("Open a TINC: URI or payment request"));

    showHelpMessageAction = new QAction(TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TINC Core help message to get a list with possible TINC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TINC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TINC network", "", count));
}
...
{
    QString strTitle = tr("TINC"); // default title
