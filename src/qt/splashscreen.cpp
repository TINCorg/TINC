    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("TINC Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString("2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin developers"));
    QString copyrightText2  = QChar(0xA9)+QString("2017 ").arg(COPYRIGHT_YEAR) + QString(tr("The HOdl-coin and TINC developers"));

    const char *inspirationals[] = {
        "Do you even TINC?",
        "The squirrel is the animal kingdom's natural HOdler.",
        "The nut is the smallest unit of TINC.",
        "There are 100,000,000 nuts in one TINC.",
        "Help! I'm being HOdled against my will.",
        "Plan for profit. Step 1:TINC, Step 2:TINC, Step 3:TINC",
        "HOdl your horses.",
