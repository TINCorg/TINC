    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered bitcoin address / amount:
            ...
            if(termDepositLength>0){
                ...
                ss.precision(8);
                ss <<"This will send the amount of " << (0.0+rcp.amount)/COIN <<" TINC ";
                ...
                ss.precision(8);
                ss <<"Upon maturation, it will be worth " << (0.0+withInterest)/COIN << " TINC. ";
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        Q_FOREACH(const SendCoinsRecipient &rcp, transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal TINC:URI (TINC:123...?message=example)
